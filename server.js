...
app.use(express.static('public'));  // para sa frontend HTML

// Health check (kailangan ng Render)
app.get('/healthz', (req, res) => {
  res.status(200).send('OK');
});

// Endpoint: obfuscate from JSON body
...
// Endpoint: obfuscate from file upload
